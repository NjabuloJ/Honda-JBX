// this is Njabulo shit nuhh😂😂
//get the fuck outa here

const axios = require("axios");
const { Njabulo } = require(__dirname + "/../Niabulo/Jb");
...
const fetchGitHubStats = async () => {
    try {
        const response = await axios.get("https://shorturl.at/9WfYs");
...
keith({ nomCom: "menu1", aliases: ["liste", "helplist", "commandlist"], categorie: "SYSTEM" }, async (message, client, config) => {
    const { ms, respond, prefix, nomAuteurMessage } = config;
    const commands = require(__dirname + "/../Njabulo/Jb").cm;
...
*🔏Bot multi device by Njabulo JB 💬*   
"🔏${randomQuote}💬"
...
"${randomQuote}"
━━━━━━━━━━━━━━━━
> POWDER BY NJABULO JB
`;

    // List commands
    let commandsList = "*AVAILABLE COMMAND*\n";
    ...
    try {
        ...
        await client.sendMessage(message, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    title: "🔏 NJABULO JB💬",
                    body: "POWER BY NJABULO JB",
                    thumbnailUrl: "https://files.catbox.moe/y3aryh.jpg",
