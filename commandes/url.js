...
zokou({nomCom:"picture",categorie: "Conversion", reaction: "✒️"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
